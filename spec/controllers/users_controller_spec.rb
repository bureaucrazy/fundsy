...
RSpec.describe UsersController, type: :controller do
  describe "#new" do
    it "instantiate a new user model object" do
      ...
      # file, we're able to mimic a get / post / patch / delete requests
      # by simply calling a method, for instance, GET and then pass it the
      # action name. So in this case we can just clal: get :new
      # we're also able to pass parameters with the request as we'll see later.
      get :new
  ...
  describe "#create" do
    # Describe and Context are interchangeable. For this case, it just adds
    # to the readability.
    context "with valid parameters" do
      ...
      it "adds a user record to the database" do
