...
RSpec.describe CampaignsController, type: :controller do
  ...
  describe "#show" do
    ...
    it "instantiates campaign variable with the Campaign whose id is passed" do
  ...
  describe "#index" do
    ...
    it "assigns an instance variable @campaigns to all created campaigns" do
      ...
      # in the db before we make a request
      campaign
      campaign_1
      get :index
  ...
  describe "#edit" do
    context "with signed in user" do
      context "with authorized user signed in" do
        ...
        it "instantiates an instance variable with the campaign whose ID is passed" do
          get :edit, id: campaign.id
          expect(assigns(:campaign)).to eq(campaign)
        end
      end
    ...
    context "with signed in user" do
      ...
      context "user is authorized" do
        ...
        context "with invalid attributes" do
          ...
          it "doesn't update the campaign" do
  ...
  describe "#destroy" do
    ...
    context "with signed in user" do
      context "user is authorized" do
        before { login(user) }
        # The ! in let! will force create :campaign even if not going to be used
        let!(:campaign) { create(:campaign, user: user) }
